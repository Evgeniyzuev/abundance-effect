...
import { Settings, LogOut, ChevronRight, Share2, Instagram, Globe, MessageCircle, Edit2, Shield, User as UserIcon } from 'lucide-react';
...
export default function SocialPage() {
    ...
    return (
        <div className="flex flex-col min-h-full bg-gray-50 pb-24">
            {/* Top Toolbar */}
            <div className="px-6 pt-safe bg-white border-b border-gray-100">
                <div className="flex items-center justify-between h-14">
                    <Link href="/" className="flex items-center gap-2">
                        <Image src="/icon-192.png" alt="Logo" width={28} height={28} className="rounded-lg shadow-sm" />
                        <span className="font-bold text-gray-900 tracking-tight italic">Abundance</span>
                    </Link>
                    <NotificationBell />
                </div>
            </div>
            ...
            <div className="px-4 space-y-6">
                ...
                <div className="bg-white rounded-3xl overflow-hidden border border-gray-100 shadow-sm">
                    ...
                    <div className="p-2 space-y-1">
                        ...
                        <div className="flex items-center justify-between px-3 py-3 rounded-2xl hover:bg-gray-50 transition-colors">
                            <span className="text-sm font-medium text-gray-500">Реинвест</span>
                ...
                <button
                    ...
                    className="w-full group bg-gradient-to-br from-blue-600 to-indigo-700 text-white rounded-3xl p-6 shadow-xl shadow-blue-500/10 flex items-center justify-between active:scale-[0.98] transition-all"
                >
                    <div className="flex items-center gap-4">
                        ...
                        <div className="text-left">
                            <h3 className="font-bold text-lg leading-tight">Моя команда</h3>
                            <p className="text-white/60 text-xs">Развивайтесь вместе</p>
                        </div>
                    </div>
