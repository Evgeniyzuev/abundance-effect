...
export default function LoginPage() {
    ...
    useEffect(() => {
        ...
        // Inject Telegram Widget Script only on desktop
        if (telegramWrapperRef.current && !isMobile) {
            ...
            // On mobile, add click handler to open Telegram directly
            const wrapper = telegramWrapperRef.current.parentElement;
            if (wrapper) {
                wrapper.addEventListener('click', () => {
                    // Use Telegram deep link to open bot
    ...
    return (
        <div className="flex min-h-screen flex-col items-center justify-center bg-ios-background p-6">
            <div className="w-full max-w-md space-y-8">
                <div className="text-center">
                    <h2 className="text-3xl font-bold tracking-tight text-ios-primary">
                        Abundance Effect
                    </h2>
                ...
                <div className="space-y-4">
                    ...
                    <div className="relative group w-full">
                        ...
                        <div className="flex w-full items-center justify-center gap-3 rounded-xl bg-white px-6 py-4 text-lg font-medium text-ios-primary shadow-sm transition-all hover:bg-gray-50 active:scale-95 cursor-pointer">
                    ...
                    <button
                        ...
                        className="group relative flex w-full items-center justify-center gap-3 rounded-xl bg-gradient-to-r from-blue-500 to-blue-600 px-6 py-4 text-lg font-medium text-white shadow-sm transition-all hover:from-blue-600 hover:to-blue-700 active:scale-95"
                    >
                        <svg className="h-6 w-6" viewBox="0 0 24 24" fill="none">
