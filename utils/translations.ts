...
export const translations: { [key in Language]: Partial<{ [key in TranslationKey]: string }> } = {
    en: {
        ...
        'onboarding.level_1': 'Level 1',
        'onboarding.level_20': 'Level 20',
        'onboarding.first_step': 'First Step',
        'onboarding.financial_stress': 'Financial Stress',
        'onboarding.freedom_joy': 'Freedom & Joy',
        'onboarding.challenges_subtitle': 'Income is always at hand',
        'onboarding.daily_challenges': 'Daily Challenges',
        'onboarding.achievements': 'Achievements',
        'onboarding.rare_rewards': 'Rare Rewards',
        'onboarding.streaks': 'Streak Progress',
        'onboarding.ai_core_subtitle': 'Daily % income',
        'onboarding.lifelong_income': 'Lifelong Income',
        'onboarding.always_working': 'Capital always working',
        'onboarding.annual_growth': 'Guaranteed annual growth',
        'onboarding.success_subtitle': 'Follow those who already did',
        'onboarding.success_stories': 'Success Stories',
        'onboarding.ai_mentor': 'AI Mentor',
        'onboarding.wishes_subtitle': 'Dream life is now accessible',
        'onboarding.define_dreams': 'Define Your Wishes',
        'onboarding.what_you_want': 'What do you really want?',
        'onboarding.track_progress': 'Track Progress',
        'onboarding.track_daily': 'Take a step every day',
        'onboarding.business_subtitle': 'Next generation system',
        'onboarding.business': 'Sales',
        'onboarding.insights_analytics': 'Clients are already waiting',
        'onboarding.automation': 'Automation',
        'onboarding.pay_first_subtitle': 'Every purchase is an investment',
        'onboarding.invest_earn_grow': 'Purchase → Participation → Growth',
        'onboarding.values_subtitle': 'Independence. Security. Sustainability.',
        'onboarding.value_security': 'Security',
        'onboarding.value_sustainability': 'Sustainability',
        'onboarding.value_independence': 'Independence',
        'onboarding.exclusive_content': 'Detailed Instructions',
    ...
    zh: {
        ...
        'onboarding.level_1': '等级 1',
        'onboarding.level_20': '等级 20',
        'onboarding.first_step': '第一步',
        'onboarding.financial_stress': '经济压力',
        'onboarding.freedom_joy': '自由与快乐',
        'onboarding.challenges_subtitle': '收入总是触手可及',
        'onboarding.daily_challenges': '每日挑战',
        'onboarding.achievements': '成就',
        'onboarding.rare_rewards': '稀有奖励',
        'onboarding.streaks': '连续进度',
        'onboarding.ai_core_subtitle': '每日 % 收入',
        'onboarding.lifelong_income': '终身收入',
        'onboarding.always_working': '资本始终工作',
        'onboarding.annual_growth': '保证年度增长',
        'onboarding.success_subtitle': '跟随已经成功的人',
        'onboarding.success_stories': '成功故事',
        'onboarding.ai_mentor': 'AI 导师',
        'onboarding.wishes_subtitle': '梦想生活现在可及',
        'onboarding.define_dreams': '定义您的愿望',
        'onboarding.what_you_want': '你真正想要什么？',
        'onboarding.track_progress': '跟踪进度',
        'onboarding.track_daily': '每天迈出一步',
        'onboarding.business_subtitle': '下一代系统',
        'onboarding.business': '销售',
        'onboarding.insights_analytics': '客户已经在等待',
        'onboarding.automation': '自动化',
        'onboarding.pay_first_subtitle': '每次购买都是投资',
        'onboarding.invest_earn_grow': '购买 → 参与 → 增长',
        'onboarding.values_subtitle': '独立. 安全. 可持续性.',
        'onboarding.value_security': '安全',
        'onboarding.value_sustainability': '可持续性',
        'onboarding.value_independence': '独立',
        'onboarding.exclusive_content': '详细说明',
    ...
    es: {
        ...
        'onboarding.level_1': 'Nivel 1',
        'onboarding.level_20': 'Nivel 20',
        'onboarding.first_step': 'Primer Paso',
        'onboarding.financial_stress': 'Estrés Financiero',
        'onboarding.freedom_joy': 'Libertad y Alegría',
        'onboarding.challenges_subtitle': 'El ingreso siempre está a mano',
        'onboarding.daily_challenges': 'Desafíos Diarios',
        'onboarding.achievements': 'Logros',
        'onboarding.rare_rewards': 'Recompensas Raras',
        'onboarding.streaks': 'Progreso de Rachas',
        'onboarding.ai_core_subtitle': 'Ingreso diario %',
        'onboarding.lifelong_income': 'Ingreso De Por Vida',
        'onboarding.always_working': 'Capital siempre trabajando',
        'onboarding.annual_growth': 'Crecimiento anual garantizado',
        'onboarding.success_subtitle': 'Sigue a quienes ya lo hicieron',
        'onboarding.success_stories': 'Historias de Éxito',
        'onboarding.ai_mentor': 'Mentor IA',
        'onboarding.wishes_subtitle': 'La vida de sueños ahora es accesible',
        'onboarding.define_dreams': 'Define Tus Deseos',
        'onboarding.what_you_want': '¿Qué realmente quieres?',
        'onboarding.track_progress': 'Seguir Progreso',
        'onboarding.track_daily': 'Da un paso cada día',
        'onboarding.business_subtitle': 'Sistema de nueva generación',
        'onboarding.business': 'Ventas',
        'onboarding.insights_analytics': 'Los clientes ya están esperando',
        'onboarding.automation': 'Automatización',
        'onboarding.pay_first_subtitle': 'Cada compra es una inversión',
        'onboarding.invest_earn_grow': 'Compra → Participación → Crecimiento',
        'onboarding.values_subtitle': 'Independencia. Seguridad. Sostenibilidad.',
        'onboarding.value_security': 'Seguridad',
        'onboarding.value_sustainability': 'Sostenibilidad',
        'onboarding.value_independence': 'Independencia',
        'onboarding.exclusive_content': 'Instrucciones Detalladas',
    ...
    hi: {
        ...
        'onboarding.level_1': 'स्तर 1',
        'onboarding.level_20': 'स्तर 20',
        'onboarding.first_step': 'पहला कदम',
        'onboarding.financial_stress': 'वित्तीय तनाव',
        'onboarding.freedom_joy': 'स्वतंत्रता और आनंद',
        'onboarding.challenges_subtitle': 'आय हमेशा हाथ में रहती है',
        'onboarding.daily_challenges': 'दैनिक चुनौतियाँ',
        'onboarding.achievements': 'उपलब्धियाँ',
        'onboarding.rare_rewards': 'दुर्लभ पुरस्कार',
        'onboarding.streaks': 'लगातार प्रगति',
        'onboarding.ai_core_subtitle': 'दैनिक % आय',
        'onboarding.lifelong_income': 'जीवनभर की आय',
        'onboarding.always_working': 'पूंजी हमेशा काम कर रही है',
        'onboarding.annual_growth': 'गारंटीकृत वार्षिक वृद्धि',
        'onboarding.success_subtitle': 'उन लोगों का अनुसरण करें जिन्होंने पहले ही किया है',
        'onboarding.success_stories': 'सफलता की कहानियाँ',
        'onboarding.ai_mentor': 'AI मेंटर',
        'onboarding.wishes_subtitle': 'सपनों का जीवन अब सुलभ है',
        'onboarding.define_dreams': 'अपनी इच्छाएँ परिभाषित करें',
        'onboarding.what_you_want': 'आप वास्तव में क्या चाहते हैं?',
        'onboarding.track_progress': 'प्रगति ट्रैक करें',
        'onboarding.track_daily': 'हर दिन एक कदम उठाएं',
        'onboarding.business_subtitle': 'अगली पीढ़ी का सिस्टम',
        'onboarding.business': 'बिक्री',
        'onboarding.insights_analytics': 'ग्राहक पहले से ही इंतज़ार कर रहे हैं',
        'onboarding.automation': 'ऑटोमेशन',
        'onboarding.pay_first_subtitle': 'हर खरीदारी एक निवेश है',
        'onboarding.invest_earn_grow': 'खरीदारी → भागीदारी → वृद्धि',
        'onboarding.values_subtitle': 'स्वतंत्रता. सुरक्षा. स्थिरता.',
        'onboarding.value_security': 'सुरक्षा',
        'onboarding.value_sustainability': 'स्थिरता',
        'onboarding.value_independence': 'स्वतंत्रता',
        'onboarding.exclusive_content': 'विस्तृत निर्देश',
    ...
    ar: {
        ...
        'onboarding.level_1': 'المستوى 1',
        'onboarding.level_20': 'المستوى 20',
        'onboarding.first_step': 'الخطوة الأولى',
        'onboarding.financial_stress': 'الضغط المالي',
        'onboarding.freedom_joy': 'الحرية والفرح',
        'onboarding.challenges_subtitle': 'الدخل دائماً في متناول اليد',
        'onboarding.daily_challenges': 'التحديات اليومية',
        'onboarding.achievements': 'الإنجازات',
        'onboarding.rare_rewards': 'المكافآت النادرة',
        'onboarding.streaks': 'تقدم المتتاليات',
        'onboarding.ai_core_subtitle': 'الدخل اليومي %',
        'onboarding.lifelong_income': 'دخل مدى الحياة',
        'onboarding.always_working': 'رأس المال يعمل دائماً',
        'onboarding.annual_growth': 'النمو السنوي المضمون',
        'onboarding.success_subtitle': 'تابع الذين فعلوا ذلك بالفعل',
        'onboarding.success_stories': 'قصص النجاح',
        'onboarding.ai_mentor': 'معلم الذكاء الاصطناعي',
        'onboarding.wishes_subtitle': 'حياة الأحلام الآن في المتناول',
        'onboarding.define_dreams': 'حدد أمنياتك',
        'onboarding.what_you_want': 'ما الذي تريده حقاً؟',
        'onboarding.track_progress': 'تتبع التقدم',
        'onboarding.track_daily': 'اتخذ خطوة كل يوم',
        'onboarding.business_subtitle': 'نظام الجيل القادم',
        'onboarding.business': 'المبيعات',
        'onboarding.insights_analytics': 'العملاء ينتظرون بالفعل',
        'onboarding.automation': 'الأتمتة',
        'onboarding.pay_first_subtitle': 'كل عملية شراء هي استثمار',
        'onboarding.invest_earn_grow': 'شراء ← مشاركة ← نمو',
        'onboarding.values_subtitle': 'الاستقلالية. الأمان. الاستدامة.',
        'onboarding.value_security': 'الأمان',
        'onboarding.value_sustainability': 'الاستدامة',
        'onboarding.value_independence': 'الاستقلالية',
        'onboarding.exclusive_content': 'تعليمات مفصلة',
