...
export const translations: { [key in Language]: Partial<{ [key in TranslationKey]: string }> } = {
    ...
    zh: {
        ...
        'onboarding.hero_description': '想象一下：醒来时没有账单焦虑，过着你梦想中的生活。但现在例行公事让人窒息，对缺钱的恐惧让人无法呼吸。如果有出路呢？我们是一个社区，AI帮助将恐惧转化为自由。不是银行，不是计划——像你一样的真实的人改变生活。',
        'onboarding.program_title': '成长计划',
        'onboarding.program_description': '记得那种薪水都花在账单上，梦想被推迟的感觉吗？从零到第20级——你的净资产增长到1,000,000美元。这不是童话：真实的步骤，每天都带来成长。想象一下你的恐惧如何消失，信心如何增长。',
    ...
    es: {
        ...
        'onboarding.hero_description': 'Imagínate: despertar sin ansiedad por las facturas, vivir la vida que soñabas. Pero ahora la rutina sofoca, el miedo a la falta de dinero impide respirar. ¿Y si hay una manera de salir? Somos una comunidad donde la IA ayuda a convertir los miedos en libertad. No es un banco, no es un esquema - gente real como tú cambiando vidas.',
        'onboarding.program_title': 'Programa de Crecimiento',
        'onboarding.program_description': '¿Recuerdas esa sensación cuando el salario se va en facturas y los sueños se posponen? De cero al nivel 20 - y tu patrimonio neto crece a $1,000,000. Esto no es un cuento de hadas: pasos reales donde cada día trae crecimiento. Imagina cómo se derriten tus miedos y crece la confianza.',
    ...
    hi: {
        ...
        'onboarding.hero_description': 'कल्पना करें: बिना बिलों की चिंता के जगना, उस जीवन को जीना जिसका आपने सपना देखा था। लेकिन अब दिनचर्या दम घोंट रही है, पैसे की कमी का डर सांस लेने से रोक रहा है। अगर एक रास्ता हो तो? हम एक समुदाय हैं जहाँ AI डर को स्वतंत्रता में बदलने में मदद करता है। कोई बैंक नहीं, कोई स्कीम नहीं - आप जैसे वास्तविक लोग जीवन बदल रहे हैं।',
        'onboarding.program_title': 'विकास कार्यक्रम',
        'onboarding.program_description': 'क्या आपको वह एहसास याद है जब तनख्वाह बिलों पर चली जाती थी और सपने टाल दिए जाते थे? शून्य से 20वें स्तर तक - और आपकी नेट वर्थ $1,000,000 तक बढ़ जाती है। यह कोई कहानी नहीं है: वास्तविक कदम जहाँ हर दिन विकास लाता है। कल्पना करें कि आपके डर कैसे पिघलते हैं और आत्मविश्वास बढ़ता है।',
    ...
    ar: {
        ...
        'onboarding.hero_description': 'تخيل: الاستيقاظ دون قلق من الفواتير، عيش الحياة التي حلمت بها. لكن الآن الروتين يخنق، والخوف من نقص المال يمنع التنفس. ماذا لو كان هناك مخرج؟ نحن مجتمع حيث تساعد الذكاء الاصطناعي في تحويل المخاوف إلى حرية. ليس بنكاً، وليس نظاماً - أشخاص حقيقيون مثلك يغيرون الحياة.',
        'onboarding.program_title': 'برنامج النمو',
        'onboarding.program_description': 'هل تتذكر ذلك الشعور عندما يذهب الراتب للفواتير وتؤجل الأحلام؟ من الصفر إلى المستوى 20 - ونمو ثروتك الصافية إلى 1,000,000 دولار. هذا ليس خيالاً: خطوات حقيقية حيث كل يوم يجلب نمواً. تخيل كيف تذوب مخاوفك وتنمو الثقة.',
    ...
    ru: {
        ...
        'onboarding.hero_description': 'Представь: просыпаешься без тревог о счетах, живешь жизнью, о которой мечтал. Но сейчас рутина душит, страх нехватки денег не дает вздохнуть. А что, если есть способ выбраться? Мы — сообщество, где AI помогает превратить страхи в свободу. Не банк, не схема — реальные люди, как ты, меняют жизнь.',
        'onboarding.program_title': 'Программа Роста',
        'onboarding.program_description': 'Помнишь то чувство, когда зарплата уходит на счета, а мечты откладываются? С нуля до 20 уровня — и твой networth вырастет до 1.000.000$. Это не сказка: реальные шаги, где каждый день приносит рост. Представь, как твои страхи тают, а уверенность растет.',
